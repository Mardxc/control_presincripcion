...
<div align="center" style="margin-bottom:100px;">
	<h1>
		Grupos del Examen de Admisión para la Preinscripción
	</h1>
</div>
<div align="right" style="float:right;" >
    <a id="imprimir_grupo" style="text-align:center;cursor:hand;"   onclick="imprimirGrupo()">
        <i class="fa fa-print fa-4x"></i>
    </a>
</div>
<table class="table table-condensed" align="center" style="width:90%;">
	<tr>
		<td>
			Periodo:
		</td>
		<td>
			<div class="row">
					<?php echo CHtml::dropDownList('periodo', 'periodo', GruExamen::getListPeriodos(),
			                   	array(
			                        'ajax' => array(
			                        'type' => 'POST',
