...
<?php 
/*	echo CHtml::link('','index.php?r=EscEdificios/create',
		array(
...
<a href="index.php?r=EscEdificios/create" style="text-align:rigth;cursor:hand;left:0%;" class="btn btn-success bt-large">
	<i class="fa fa-plus">Nuevo Periodo</i>
</a>

<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'esc-edificios-grid',
	'itemsCssClass'=>"table table-hover table-bordered ",
	'pager'=>array("htmlOptions"=>array("class"=>"pagination")),
	'emptyText'=>'No existen resultados en esta busqueda',
	'summaryText'=>'{start}-{end} de {count} Edificios',
	...
	'columns'=>array(
		...
		array(
			'name'=>'id_institucion',
			'header'=>'INSTITUCION',
			'value'=>'escEdificios::getNameInstitucion($data->id_institucion)',
			'filter'=>escEdificios::getListInstituciones(),
		),
		array(
			'class'=>'CButtonColumn',
			'header'=>'ACCIONES',
