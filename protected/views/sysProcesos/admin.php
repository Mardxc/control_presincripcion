...
<?php 
	/*echo CHtml::link('','index.php?r=SysProcesos/create',
		array(
...
<a href="index.php?r=SysProcesos/create" style="text-align:rigth;cursor:hand;left:0%;" class="btn btn-success bt-large">
	<i class="fa fa-plus">Nuevo Periodo</i>
</a>

<?php $this->widget('zii.widgets.grid.CGridView', array(
	'id'=>'sys-procesos-grid',
	'itemsCssClass'=>"table table-hover table-bordered ",
	'pager'=>array("htmlOptions"=>array("class"=>"pagination")),
	'emptyText'=>'No existen resultados en esta busqueda',
	'summaryText'=>'{start}-{end} de {count} Procesos',
	...
	'columns'=>array(
		...
		array(
			'name'=>'id_modulo',
			'header'=>'MODULO',
			'value'=>'SysProcesos::getNameModulo($data->id_modulo)',
			'filter'=>SysProcesos::getListModulos(),
		),
		array(
			'class'=>'CButtonColumn',
			'header'=>'ACCIONES',
